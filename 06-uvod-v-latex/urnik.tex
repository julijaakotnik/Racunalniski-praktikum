...
\[ velikostTabele = steviloUrNaDan \cdot steviloDelovnihDni \]
...
kakovost urnika:
\[
k_1 \cdot u_1 + \cdots + k_{n-1} \cdot u_{n-1} + k_n \cdot u_n
\]
...
Avto\{Program za izdelavo urnika\}matizirana izdelava urnika 
...
\begin{itemize}
 \item \emph{Vstavljanje} srečanja v urnik.
   \item \emph{Brisanje} erečanja iz urnika.
   \item \emph{Zamenjava} edveh srečanj v urnik.
\end{itemize}
%
% Spodnja vrstica ne začne novega odstavka, zato ne bi smela biti zamaknjena.
% To popravite z ukazom `\noindent` ali pa tako, da odstranite prazno vrstico.
